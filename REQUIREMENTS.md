...
- `build.gradle.kts` (root) — Java plugin, group `ssg`, version `0.2.0-SNAPSHOT`, shared subproject config with centralized dependency versions (SLF4J 2.0.16, JUnit 5.11.4, Mockito 5.14.2, AssertJ 3.27.3)
...
2. Group ID `ssg`, artifact ID `pex`, version `0.2.0-SNAPSHOT`
...
| 0.2.0-SNAPSHOT | August 2026 | 5 | 3,015 | ~69,700 | 13 | Post-release: NoSQL, compliance, docs |
